...
SAVE_PATH = 'rs_oritvae/pretraining_1e-4'
...
for epoch in range(TOTAL_EPOCHS):
    ...
    for i, path in enumerate(list_data_paths):
        ...
        train_data, val_data = load_tensor_data_v3(path, 0.3, add_padding, **{'max_dim': MODEL_CONFIG['input_dim']})
