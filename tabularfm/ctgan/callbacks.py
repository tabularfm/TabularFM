...
class EarlyStopping:
    ...
    def __init__(self, patience=7, verbose=False, delta=0, path='checkpoint.pt', trace_func=print, encoder_name="", decoder_name=""):
        """
        Args:
        ...
        # prepare path
        self.encoder_path = self.path + '/' + encoder_name + '.pt'
        self.decoder_path = self.path + '/' + decoder_name + '.pt'
