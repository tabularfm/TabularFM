...
SET_NAME = 'val_paths'
FINETUNE_PATH = 'rs_oritvae/finetune_val_1e-4'
SINGLETRAIN_PATH = 'rs_oritvae/single_val_1e-4'
SCORE_SAVE_PATH = 'rs_oritvae/scores_val.csv'
...
for ds in list_data_paths:
    ...
    # load weights
    ft_model = CustomTVAE(**FINETUNE_MODEL_CONFIG)
    ...
    st_model = CustomTVAE(**SINGLE_MODEL_CONFIG)
